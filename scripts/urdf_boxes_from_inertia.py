...
· **치수 계산·조향각에는 절대 쓰지 않는다.** 당시 CAD 자산(윤거 705·879·585 mm)과
  현재 런타임 제작 v2(545·719·425 mm)는 다른 버전이다. 제어 기하는
  `chassis/kinematics.py`가 정본이며 이 스크립트는 **RViz 시각화용 근사 껍데기**만 만든다.
