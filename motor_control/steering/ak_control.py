...
# 조향 슬루 속도. 1500→4500(2026-07: 원격조종 응답성). 출력축 deg/s ≈ erpm/84
# → 4500 ≈ 47°/s, 45° 약 0.85s(무부하 실측, 오버슈트 0). 정격 5180 이내라 지속 안전.
# (4500→6000 은 짧은 스텝서 0.1s 만 개선돼 효율↓.) acc 도 20000 으로 올려 짧은 조향도
# 최고속 근처까지 가속. ⚠️ 실링키지 부하 시 각속도 다소↓·전류↑ → 필요시 하향.
DEFAULT_SPD_ERPM = 4500
DEFAULT_ACC_ERPM_S2 = 20000
