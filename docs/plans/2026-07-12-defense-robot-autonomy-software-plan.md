...
- US-100 near/no-response와 모터 fault의 latched E-stop 정책은 변경하지 않음. *(개정 2026-07-18, 스펙 r6 §6.1/C0: US-100 **단독** latch에 한해 콘솔 grant 후진 전용 EXTRACTION 상태(clamp −0.2 m/s·TTL·budget, latch 보존)를 추가 — 벤치 후진 HIL 통과 전 실기 활성 금지.)*
