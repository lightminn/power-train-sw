...
**후속 USB 진단:** MKS 보드의 실제 node 13/14 설정은 정상이고 firmware는 0.5.1 unreleased였다. 보드 CAN부만 재초기화해 최종 10/10을 복구했다. 이 문서의 8/10·USB 미연결 기록은 그 이전 상태다. [최신 진단·MKS 송신 경합 분석](2026-09-09-mks-usb-can-diagnosis.md).
